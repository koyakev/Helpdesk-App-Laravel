<div>
    ...
    @if($user->role == 'L4')
        <nav class="h-full bg-black text-white p-2 w-40">
            <a href="{{ route('admin_users') }}" class="block mt-15 m-2 text-end hover:font-bold">Users</a>
            <a href="{{ route('admin_departments') }}" class="block m-2 text-end hover:font-bold">Departments</a>
        </nav>
