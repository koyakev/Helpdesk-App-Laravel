...
<div>
    ...
    <div x-data="{ open: false }">
        ...
        <div x-show="open" x-cloak class="absolute top-0 left-0 w-full h-screen flex justify-center items-center">
            <div class="w-1/3 h-auto bg-white shadow-sm shadow-green-400 rounded-xl p-3">
                ...
                <div class="p-6">
                    <form method="POST" action={{ route('create_department') }}>
                        ...
                        <input type="text" name="manager_id" placeholder="Manager ID" class="border border-green-700 rounded-md p-2 w-full my-3">
            ...
            <tbody>
                @foreach($departments as $department)
                    <tr class="odd:bg-green-100">
                        ...
                        <td class="p-2 w-1/4">{{ $department->manager_id }}</td>
                        <td></td>
                    </tr>
                @endforeach
            </tbody>
